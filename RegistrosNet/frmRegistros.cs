...
namespace RegistrosNet
{
    ...
    public partial class frmRegistros : Form
    {
        ...
        private void cmbTema_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyData)
            {
                ...
                case ( Keys.Control | Keys.D1):
                    this.Text = "REGISTRO DE EVENTOS" + " (Control y 1 ordena Temas alfabéticamente)";
                    CargarComboTemaAlfabeticamente();
                    cmbTema.SelectedIndex = 1;
                    break;

                case (Keys.Control | Keys.D2):
                    this.Text = "REGISTRO DE EVENTOS" + " (Control y 2 ordena Temas por fecha)";
                    CargarComboTemaUltimo();
                    cmbTema.SelectedIndex = 1;
                    break;
        ...
        {
            FileSystemWatcher Examinador = new FileSystemWatcher(@"C:\REGX");
        ...
        private void Backupeo()
        {
            ...
            origenBackupTablas = @"C:\REGX\BACKUP\TABLAS\" + fecha + ".sql";
            ...
            foreach (string rutaDestino in rutas)
            {
                ...
                {
                    origen = rutaDeHoy["ruta"].ToString();
                    try
                    {
